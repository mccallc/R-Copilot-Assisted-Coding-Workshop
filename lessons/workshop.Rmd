---
title: "Maxwell Copilot Assisted Coding Workshop"
output: html_notebook
---

## Learning Objectives

Welcome to the Maxwell GitHub Copilot Workshop. After this workshop, you will be able to:
...
### 🥊 Challenge 3: 
Start typing `unique_countries <- ` and see what suggestions Copilot gives you. You may need to wait a second for the suggestion to appear or continue typing. Click `Tab` to accept the suggestion. This should complete the code to create a vector of unique countries in the `gap` data frame.
```{r}
# Start typing here
```
